								...
								<ul class="products">
									<?php
										...
										if ( $loop->have_posts() ) {
											...
											echo __( 'No products found', 'fox-shop' );
										}
										wp_reset_postdata();
									?>
								</ul><!--/.products-->
								<a href="<?php esc_url( $shop_page_url ); ?>" class="button btn btn-block" aria-label="<?php esc_attr_e( 'View all products in shop', 'fox-shop' ); ?>"><?php esc_html_e( 'View all products in shop', 'fox-shop' ); ?></a>
							<?php
							else:
									if ( have_posts() ) :
										...
										echo fox_shop_get_the_posts_navigation();
