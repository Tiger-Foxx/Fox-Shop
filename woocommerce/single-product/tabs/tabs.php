...
<?php
/*
* close div of row fox-shop-woocommerce-row opened in fox_shop_woocommerce_before_single_product_summary() of woocommerce.php
*/
?>
</div>
...
if ( ! empty( $product_tabs ) ) : ?> 
	...
	<div class="row fox-shop-woocommerce-row">
		<ul class="nav nav-tabs fox-shop-woocommerce-nav-tabs">
			<?php 
		...
		<div class="tab-content ">
			<?php 
				...
				foreach ( $product_tabs as $key => $product_tab ) : ?>
				<div class="tab-pane fox-shop-woocommerce-nav-tab-pane <?php if( $first_tab_content ){ echo 'active'; $first_tab_content = false; } ?>" id="tab-<?php echo esc_attr( $key ); ?>" role="tabpanel" aria-labelledby="tab-title-<?php echo esc_attr( $key ); ?>">
